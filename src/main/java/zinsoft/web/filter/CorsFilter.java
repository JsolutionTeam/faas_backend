...
/**
 * <p>
 * A {@link Filter} that enable client-side cross-origin requests by implementing W3C's CORS (<b>C</b>ross-<b>O</b>rigin <b>R</b>esource <b>S</b>haring) specification for resources. Each {@link HttpServletRequest} request is inspected as per specification, and appropriate response headers are added to {@link HttpServletResponse}.
 * </p>
 * 
 * <p>
 * By default, it also sets following request attributes, that help to determine the nature of the request downstream.
 * <ul>
 * <li><b>cors.isCorsRequest:</b> Flag to determine if the request is a CORS request. Set to <code>true</code> if a CORS request; <code>false</code> otherwise.</li>
...
public final class CorsFilter implements Filter {
    ...
    public void doFilter(final ServletRequest servletRequest, final ServletResponse servletResponse, final FilterChain filterChain) throws IOException, ServletException {
        ...
        switch (requestType) {
            ...
            default:
                ...
                this.handleInvalidCORS(response);
                break;
        }
    }
    ...
    public void init(final FilterConfig filterConfig) throws ServletException {
        // Initialize defaults
        parseAndStore(DEFAULT_ALLOWED_ORIGINS, DEFAULT_ALLOWED_HTTP_METHODS, DEFAULT_ALLOWED_HTTP_HEADERS, DEFAULT_EXPOSED_HEADERS, DEFAULT_SUPPORTS_CREDENTIALS, DEFAULT_PREFLIGHT_MAXAGE, DEFAULT_DECORATE_REQUEST, DEFAULT_IGNORE_URL_PREFIX);
        ...
        if (filterConfig != null) {
            ...
            String configIgnoreUrlPrefix = filterConfig.getInitParameter(PARAM_CORS_IGNORE_URL_PREFIX);

            parseAndStore(configAllowedOrigins, configAllowedHttpMethods, configAllowedHttpHeaders, configExposedHeaders, configSupportsCredentials, configPreflightMaxAge, configDecorateRequest, configIgnoreUrlPrefix);
        }
    }
     ...
     *            The {@link FilterChain} object.
     */
    private void handleInvalidCORS(final HttpServletResponse response) {
     ...
     * <ul>
     * <li><b>cors.isCorsRequest:</b> Flag to determine if request is a CORS request. Set to <code>true</code> if CORS request; <code>false</code> otherwise.</li>
     * <li><b>cors.request.origin:</b> The Origin URL.</li>
     * <li><b>cors.request.type:</b> Type of request. Values: <code>simple</code> or <code>preflight</code> or <code>not_cors</code> or <code>invalid_cors</code></li>
     * <li><b>cors.request.headers:</b> Request headers sent as 'Access-Control-Request-Headers' header, for pre-flight request.</li>
     * </ul>
     * 
     * @param request
    ...
    protected CORSRequestType checkRequestType(final HttpServletRequest request) {
        ...
        if (ignoreUrlPrefix != null) {
            String contextPath = request.getContextPath();
            String path = request.getRequestURI();
            if (path.startsWith(ignoreUrlPrefix, contextPath.length())) {
     ...
     * @param ignoreUrlPrefix
     * @throws ServletException
     */
    private void parseAndStore(final String allowedOrigins, final String allowedHttpMethods, final String allowedHttpHeaders, final String exposedHeaders, final String supportsCredentials, final String preflightMaxAge, final String decorateRequest, final String ignoreUrlPrefix) throws ServletException {
    ...
    protected static boolean isValidOrigin(String origin) {
        ...
        if (origin.startsWith("file://") || origin.equals("null")) {
            return true;
        }
    ...
    public static final String DEFAULT_IGNORE_URL_PREFIX = null;
    ...
    public static final String PARAM_CORS_IGNORE_URL_PREFIX = "cors.ignore.url.prefix";
}
